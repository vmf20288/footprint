...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	public class ChartNetChange : Gui.NinjaScript.MarketAnalyzerColumnRenderBase
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Description				= Custom.Resource.NinjaScriptMarketAnalyzerColumnDescriptionChartNetChange;
				Name					= Custom.Resource.NinjaScriptMarketAnalyzerColumnNameChartNetChange;
				DownArea				= Core.Globals.GeneralOptions.BrushDownPrimary;
				DownOutline				= Core.Globals.GeneralOptions.BrushDownPrimary;
				IsDataSeriesRequired	= true;
				Opacity					= 50;
				UpArea					= Core.Globals.GeneralOptions.BrushUpPrimary;
				UpOutline				= Core.Globals.GeneralOptions.BrushUpPrimary;
			}
